...
function FlagGame() {
    ...
    return (
        <>
            <section className="min-h-screen py-4 md:py-12 px-2 md:px-10 bg-linear-to-br from-slate-50 to-slate-200 mt-13 md:mt-20 font-sans">
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-start gap-4 md:flex-col">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <p className="text-[10px] md:text-sm text-white/80 mt-1 md:mt-3 leading-tight max-w-50">
                                                {lvl.desc}
                                            </p>
                                        </div>
                                    </div>
