        ...
        <div className="max-w-350 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
            {levels.map((lvl) => (
              <div
                key={lvl.id}
                className={`group relative rounded-2xl md:rounded-3xl p-5 md:p-8 h-32 md:h-64 flex flex-col justify-between overflow-hidden bg-linear-to-br ${lvl.gradient} text-white shadow-md hover:shadow-2xl transition-all duration-500 md:hover:-translate-y-2`}
              >
