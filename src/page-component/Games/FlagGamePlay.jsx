            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500 font-medium italic text-sm text-center tracking-tight">
                        Xəritələr və bayraqlar yüklənir...
                    </p>
                </div>
            </div>
        );
                        ...
                        <div className="lg:flex lg:gap-6">
                            <div className="hidden lg:block lg:w-1/3">
                                <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-5 md:p-6 hover:shadow-xl transition-shadow duration-300 sticky top-6">
                                    <h1 className="text-lg font-bold text-slate-800 leading-none mb-2">Bayraq Oyunu</h1>
                            ...
                            <div className="lg:w-2/3">
                                <div className="lg:hidden bg-white rounded-2xl shadow-lg border border-slate-200 p-5 md:p-7 mb-4 sm:mb-6 hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-center justify-between gap-2">
                                        <div>
                                            <h1 className="text-xs sm:text-sm font-bold text-slate-800 leading-none mb-1">Bayraq Oyunu</h1>
                                            ...
                                            <div className="flex gap-0.5 sm:gap-1">
                                                {[...Array(MAX_LIVES)].map((_, i) => (
                                                    <Heart
                                                        ...
                                                        className={`${i < lives ? "text-red-600 hover:scale-110 transition-transform" : "text-slate-200"}`}
                                                    />
                                                ))}
                                            </div>
                                ...
                                <div className="flex flex-col gap-4 sm:gap-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                                        {options.map((opt, i) => {
                                            ...
                                            return (
                                                <button key={i} disabled={!!selectedAnswer} onClick={() => handleAnswer(opt.name.common)} className={btnClass}>
