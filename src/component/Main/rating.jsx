        ...
        <div className="max-w-2xl mx-auto">
          <div className="relative flex items-end justify-center gap-2 mb-8 h-48 md:h-56">
            <div className="flex flex-col items-center w-24 md:w-32">
              ...
              <div className="bg-linear-to-br from-emerald-400 to-teal-600 w-full h-12 md:h-16 rounded-t-xl flex flex-col items-center pt-2 border-t border-white/20">
            ...
            <div className="flex flex-col items-center w-28 md:w-40 z-10 scale-105">
              ...
              <div className="bg-linear-to-br from-yellow-500 to-pink-600 w-full h-20 md:h-28 rounded-t-2xl flex flex-col items-center pt-3 border-t border-white/30 shadow-xl">
            ...
            <div className="flex flex-col items-center w-24 md:w-32">
              ...
              <div className="bg-linear-to-br from-green-600 to-lime-400 w-full h-10 md:h-14 rounded-t-xl flex flex-col items-center pt-2 border-t border-white/20">
