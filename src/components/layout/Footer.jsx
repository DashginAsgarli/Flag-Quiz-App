...
import { FaEnvelope, FaInstagram, FaGithub, FaLinkedin, FaChevronUp } from "react-icons/fa";
                ...
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 md:gap-10 pb-8 md:pb-12">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-4">
                        <div className="relative group">
                            ...
                            <div className="relative p-3 md:p-4 bg-slate-900 border border-slate-800 rounded-2xl md:rounded-3xl  transition-transform group-hover:-rotate-12">
                                <GiGlobe size={24} className="text-red-500" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-end gap-6">
                        <div className="flex items-center gap-2 p-1.5 bg-slate-900/40 border border-slate-800/50 rounded-2xl backdrop-blur-md">
                            {[
                                ...
                                <a key={i} href={item.link} target="_blank" rel="noopener noreferrer" className={`w-9 h-9 md:w-10 md:h-10 flex items-center justify-center rounded-xl text-slate-400 hover:text-white transition-all duration-300 ${item.hover}`}>
